        ...
        <View style={{}}>
          ...
          {this.state.given==true &&
            <List>
                ...
                {this.state.recieved == true &&
                    <Text style={{width:"80%",marginLeft:'12%',borderBottomWidth:0.3}}>sdafvadsvdsfvdsavdagvaegerageargaaegeag
                ...
                <ListItem style={{marginLeft:40}}>
                <Left>
                <Text style={{ fontSize: 16 }}>Why Do I Have to Pay Account to Access Some Map</Text>
                </Left>
