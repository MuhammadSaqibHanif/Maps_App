    ...
    return (
     ...
     /> */}
        <Header
          ...
          centerContainerStyle={{ flexBasis: "70%", alignItems: "center" }}
        ...
        >
          <View>
            <Image
              ...
              style={{ width: 130, height: 150, marginLeft: 20 }}
            />
          </View>
          <View style={{ marginLeft: 10 }}>
            <Text style={{ fontSize: 30, fontWeight: "bold" }}>About Me</Text>
            <Text>
              I am the ethusiat person to tell the way to the tourist, I am glad
              by providing this service I am the ethusiat person to tell the way
              to the tourist, I am glad by providing this service
            </Text>
          </View>
        </View>
        <View
